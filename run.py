...
from numerics.vorticity import bc_vort,macCormack_w
from numerics.energy import bc_theta,macCormack_theta
from numerics.poisson import bc_uvPsi,eulerExp,uAndV
...
m_data,t_data = equilibriumMag.equilibriumMag(m_data,t_data,phi,M_d,alpha0,beta,nx1,ny1,volNumb,CVdata,Le)  # Calculating equilibrium magnetization
